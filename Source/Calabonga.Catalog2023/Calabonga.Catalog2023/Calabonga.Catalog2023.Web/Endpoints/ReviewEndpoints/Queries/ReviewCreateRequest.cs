...
public record ReviewCreateRequest(ReviewCreateViewModel Model, ClaimsPrincipal User)
	: IRequest<OperationResult<ReviewViewModel>>;

public class ReviewCreateRequestHandler
	: IRequestHandler<ReviewCreateRequest, OperationResult<ReviewViewModel>>
{
	private readonly IMapper _mapper;
	private readonly IUnitOfWork _unitOfWork;

	public ReviewCreateRequestHandler(
		IMapper mapper,
