...
{
	public record ReviewUpdateRequest(ReviewUpdateViewModel Model, ClaimsPrincipal User)
		: IRequest<OperationResult<ReviewViewModel>>;

	public class ReviewUpdateRequestHandler
		: IRequestHandler<ReviewUpdateRequest, OperationResult<ReviewViewModel>>
	{
		private readonly IUnitOfWork _unitOfWork;
		private readonly IMapper _mapper;

		public ReviewUpdateRequestHandler(IUnitOfWork unitOfWork, IMapper mapper)
		{
			_unitOfWork = unitOfWork;
			_mapper = mapper;
		}

		public async Task<OperationResult<ReviewViewModel>> Handle(ReviewUpdateRequest request, CancellationToken cancellationToken)
		{
